...
<nav class="navbar" id="navbar">
  ...
  <ul class="nav-links">
    <li><a href="browse.php" class="active">Home</a></li>
...
<div class="hero">
  ...
  <div class="hero-content">
    <div class="hero-label"><i class="fa-solid fa-fire"></i> Featured tonight</div>
...
<div class="filter-bar" id="filters">
  ...
  <button class="filter-btn" data-type="movie"><i class="fa-solid fa-film"></i> Movies</button>
  <button class="filter-btn" data-type="series"><i class="fa-solid fa-tv"></i> Series</button>
</div>
...
<div class="gallery-wrapper">
  <div class="gallery-header">
    <div class="gallery-title">
      <span class="row-title-accent"></span> All Titles
  ...
  <div class="grid" id="catalog">
    <?php foreach ($all as $m):
      $isFav = in_array($m['id'],$favIds); $isWL = in_array($m['id'],$wlIds); $isS = $m['type']==='series'; ?>
    <div class="card animated-card"
      ...
      <span class="card-badge <?= $isS?'badge-series':'badge-movie' ?>"><?= $isS?'S':'M' ?></span>
      ...
      <div class="card-body">
        ...
        <div class="card-meta">
          ...
          <?php if ($isS && $m['seasons']): ?><span><?= $m['seasons'] ?>S</span><?php endif; ?>
...
let activeGenre = 'all', activeType = null;
...
function applyFilters(){
  ...
  document.querySelectorAll('#catalog .card').forEach(c => {
    ...
    const tMatch = !activeType || c.dataset.type === activeType;
    const qMatch = !q || c.dataset.title.includes(q);
    const show = gMatch && tMatch && qMatch;
  ...
  document.getElementById('count-badge').textContent = vis + ' titles';
}

function resetFilters(){
  activeGenre = 'all'; activeType = null;
...
document.querySelectorAll('.filter-btn').forEach(btn => {
  btn.addEventListener('click', () => {
    ...
    if (btn.dataset.genre){ activeGenre = btn.dataset.genre; activeType = null; }
    else if (btn.dataset.type){ activeType = btn.dataset.type; activeGenre = 'all'; }
    applyFilters();
  });
});
