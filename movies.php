...
// Get only movies
$all = $conn->query("SELECT * FROM media WHERE type='movie' ORDER BY rating DESC")->fetch_all(MYSQLI_ASSOC);
...
<div class="hero">
  ...
  <div class="hero-content">
    <div class="hero-label"><i class="fa-solid fa-film"></i> Featured Movie</div>
...
<div class="gallery-wrapper">
  <div class="gallery-header">
    <div class="gallery-title">
      <span class="row-title-accent"></span> All Movies
      <span class="count-badge" id="count-badge"><?= count($all) ?> movies</span>
    </div>
  </div>
  ...
  <div class="grid" id="catalog">
    ...
    <div class="card animated-card"
      ...
      <span class="card-badge badge-movie">M</span>
...
function applyFilters(){
  ...
  document.getElementById('count-badge').textContent = vis + ' movies';
}
